	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container-fluid">
				<a href="#" class="navbar-brand"><b>Hospital Management App</b></a>
				<div class="collapse navbar-collapse justify-content-between"
					id="navbarCollapse">
					<div class="navbar-nav">
						<a href="<%=request.getContextPath()%>/list"
							class="nav-item nav-link">List of Patients</a>
					</div>
				</div>
			</div>
		</nav>
	...
	<main>
		...
		<div class="container">
			<button type="button" class="btn btn-success" data-toggle="modal"
				data-target="#addUserModal">Add New Patient Record</button>
		</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="addUserModalLabel">Add New Patient</h5>
						...
						<form action="insert" method="post">
							...
							<div class="form-group">
								<label for="bgroup">Blood Group</label> <input type="text"
									class="form-control" id="bgroup" name="bgroup" required>
							</div>
							<div class="form-group">
